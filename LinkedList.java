...
public class LinkedList<T> implements Iterable<T> {
 ...
 /* The method should modify the list data structure by changing 
    the next and prev references in the linked list nodes.
  */
  ...
  /********* ADD YOUR SOLUTIONS HERE *****************/
    ...
    public void reverse() {
        ...
        /*My reverse method runs in O(N) time. A different way to make the 
         * reversal of the list a O(1) operation is to have all the next 
         * methods reference the previous node and all the previous nodes reference 
         * the next node and then print out the result, which will be reversed
         * because the pointers will be in opposite directions.
         */
        // write this method.
